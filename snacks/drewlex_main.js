...
if(mv_slider) {
  ...
  mv_slider_main_css.href="/owl.carousel.min.css";
  ...
  mv_slider_default_css.href="/owl.theme.default.css";
...
function initFeatures(settings) {
    ...
    if (!settings.formApi || !settings.formApi.isNeeded) {
        var featuresFilesSrc = (window.location.protocol == 'file:') ? {
            ...
            autoCommStyles: 'autoComments.css',
            popupsStyles: 'popups.css',
            popupsIconUser: 'cdn/img/count-user_black.png',
            popupsIconOrder: 'count-order-984_black.png',
            prizeWheel: 'prizewheel.png',
            wheelCursor: 'wheel-cursor.png',
            wheelStyles: 'wheel.css',
